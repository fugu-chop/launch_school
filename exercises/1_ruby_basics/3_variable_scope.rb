...
puts a
=end
puts "a will print 7. Reassignment, including assignment operators like +=, does not mutate a variable; instead, it binds the variable to a new object. That is, += sets the variable to point to a different object."
...
puts "An interesting tidbit - if we were to pass a + 'Y' into my_value (i.e. b += 'Y'), a would remain unchanged. This is because the b argument in my_value is no longer referring to 'a' in the global scope, but a new instance of the variable (also since + 'Y' is not a destructive method)."
...
puts a
=end
puts "a will print Xyzzy. Reassignment, including assignment operators like =, do not mutate a variable in the context of a method definition; instead, it binds the variable to a new object."
...
puts a
=end
puts "a will print as 7, whereas the function will return an error. This is another example of method not having access to local variables outside of their definition, and so the my_value function does not know what a is. If we had assigned b = 5, then my_value would simply have returned 5."
...
puts a
=end
puts "a will now print 3. This is because this is a method invocation with a block and not a method definition. This means there is no creation of inner scope, allowing for the a variable to be reassigned."
...
puts a
=end
puts "The variable a remains unchanged, since my_value is a method definition, it does not have context of the outer scope. The my_value method will throw an error, since it has no context of what 'a' is."