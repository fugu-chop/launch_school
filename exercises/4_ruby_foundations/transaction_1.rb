class Transaction
  ...
  def prompt_for_payment(input: $stdin, output: $stdout)
    loop do
      ...
      # The StringIO object provides a gets method here (instead of Kernel#gets). input.gets works just like the normal gets, but gets information from the object specified by input.
